// pages/tournaments-hub/valorant-types/5v5/index.js
import React from "react";
import Link from "next/link";
import { useRouter } from "next/router";
import styles from "../../../../styles/Valorant5v5.module.css";
...
// ----- PAGE COMPONENT -----
export default function Valorant5v5ListPage({ tournaments }) {
    ...
    <div className={styles.shell}>
      <div className={styles.contentWrap}>
        ...
        <section className={styles.hero}>
          <div className={styles.heroBadge}>VALORANT 5v5</div>
          <h1 className={styles.heroTitle}>UPCOMING TEAM TOURNAMENTS</h1>
          <p className={styles.heroSubtitle}>
            Full team brackets for coordinated squads. Matches are run in
            custom lobbies and organized through the 5TQ Discord server.
          </p>
        </section>
