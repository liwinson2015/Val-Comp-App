  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10">
      ...
      <div className="mt-8 grid gap-6">
        ...
        <div className="rounded-2xl border border-gray-700 bg-[#111] p-6 shadow-sm hover:shadow-md transition">
          ...
          <div className="mt-5 flex gap-3">
            ...
            <Link
              ...
              className="inline-block border border-gray-600 text-gray-300 px-4 py-2 rounded-lg text-sm hover:bg-gray-800 transition"
            >
              Back
            </Link>
          </div>
